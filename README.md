...
<table class="table table-hover table-bordered">
  <tr>
   ...
   <tr>
    <td scope="row">FlowCF</td>
        <td>Liu et al. <a href="https://dl.acm.org/doi/10.1145/3711896.3736967" target="_blank">Flow Matching for Collaborative Filtering</a>, KDD'25.
   ...
   <tr>
    <td scope="row">PreferDiff (Graph-Based Ver.)</td>
  ...
  <tr>
   <td scope="row">SCCF</td>
    ...
    <tr>
     <td scope="row">CF-Diff</td>
         <td>Hou et al. <a href="https://dl.acm.org/doi/10.1145/3626772.3657742" target="_blank">Collaborative Filtering Based on Diffusion Models: Unveiling the Potential of High-Order Connectivity</a>, SIGIR'24.
          </td> <td>Graph + DM</d> <td>PyTorch</d>
       </tr>
    <tr>
